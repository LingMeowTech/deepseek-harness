/**
 * Package-owned invariant companion for `@lingmeow.tech/dsh-session-tags`.
 * @module @lingmeow.tech/dsh-session-tags/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@lingmeow.tech/dsh-session-tags'
