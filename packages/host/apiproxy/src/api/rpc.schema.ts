...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('pipeline-not-found'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('pipeline-unauthorized'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('pipeline-forbidden'), message: z.string(), details: z.object({}) }),
  z.object({ code: z.literal('pipeline-error'), message: z.string(), details: z.object({ httpStatus: z.number().int().optional() }) }),
  ...
  z.object({ code: z.literal('not-found'), message: z.string(), details: z.object({ childSessionId: z.string() }) }),
