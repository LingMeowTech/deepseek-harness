...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/pipeline/lmo-pipeline': { kind: 'indirect', reason: 'The service interface delegates model rendering to dsh-tool-lmo-pipeline.' },
  'packages/pipeline/lmo-pipeline-http': { kind: 'indirect', reason: 'The provider backend delegates model rendering to dsh-tool-lmo-pipeline.' },
  'packages/session/session-tags': { kind: 'indirect', reason: 'The tag registry is host data plane state; host and client consumers own any model-visible rendering.' },
