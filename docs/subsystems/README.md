...
| [pipeline.md](pipeline.md) | the LMO pipeline surface this repository keeps: the `ctx.sessionTags` registry, its `SessionTags*` wire types, and the tag contract pipeline sessions carry |
